...
**2026-07-21 09:45 KST 기준 공식몰 세일 73곳**을 날짜 고정 스냅샷으로 공개했다.

- **GitHub Pages:** https://pinion05.github.io/domestic-brand-sale-scan/
- **Markdown 보고서:** [`reports/2026-07-21.md`](reports/2026-07-21.md)

페이지에는 할인율이 확인된 48곳, 세일 페이지가 노출 중인 25곳, 제외 사유와 조사 범위를 함께 기록했다.
...
2026-07-21 실행에서 10페이지를 순회해 416개 초기 후보와 158개 렌더링 대상을 얻었다. 렌더링 후 화면에 세일 신호가 보이는 국내 패션 후보 73개(할인율 확인 48개, 세일 페이지 노출 25개)를 확인했다.
